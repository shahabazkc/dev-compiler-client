...
const Loader: React.FC<Props> = ({ show }) => {
  const { themeBaseColor } = usePages()
  return (
    <>
      {show && (
        <div style={{ backgroundColor: themeBaseColor.background }} className="fixed z-50 inset-0 opacity-50 flex items-center justify-center">
